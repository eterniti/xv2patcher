...
static uint8_t orig_ins1[7], orig_ins2[6], orig_ins3[5];
...
{
	static uint8_t patch2[6] = { 0xBB, 0x01, 0x00, 0x00, 0x00, 0x90 }; // mov ebx, 1; fill with nop; (ORIGINAL CODE: test eax, eax; cmovz ebx, r15d; r15d = 0 constant here)
