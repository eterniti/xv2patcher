...
OBJS += ../eternity_common/BaseFile.o ../eternity_common/IniFile.o
...
OBJS += ../eternity_common/DBXV2/MsgFile.o ../eternity_common/DBXV2/IdbFile.o ../eternity_common/DBXV2/QsfFile.o ../eternity_common/DBXV2/CusFile.o
OBJS += ../eternity_common/DBXV2/Xv2PreBakedFile.o ../eternity_common/DBXV2/Xv2StageDefFile.o ../eternity_common/DBXV2/Xv2PatcherSlotsFile.o ../eternity_common/DBXV2/Xv2LobbyDefFile.o
...
CFLAGS += -DXV2 
CXXFLAGS +=-Wall -Wno-strict-aliasing -Wno-invalid-offsetof -I../eternity_common -I../eternity_common/DBXV2 -I./xbyak -O2 -std=c++11 -mms-bitfields -DTIXML_USE_STL -DXV2_STAGEDEF_SIMPLE -DIDB_SIMPLE -DCUS_SIMPLE
...
LIBS = -lstdc++ -lversion -lminhook -ldbghelp
