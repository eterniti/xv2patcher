...
CFLAGS += -DXV2 
CXXFLAGS +=-Wall -Wno-strict-aliasing -I../eternity_common -I../eternity_common/DBXV2 -O2 -std=c++11 -mms-bitfields -DTIXML_USE_STL -DXV2_STAGEDEF_SIMPLE -DIDB_SIMPLE -DCUS_SIMPLE
